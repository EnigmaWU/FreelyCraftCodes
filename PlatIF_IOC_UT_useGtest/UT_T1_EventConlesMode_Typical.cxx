...
// Step-4: ObjB as EvtPuber postEVT(EvtID==TEST_MOVE_VERTICAL/TEST_MOVE_HORIZONTAL) in a thread named "ObjB_Thread1",
//          alternativly every 1ms*$_UT_EVTCNT_MOVE_VERTICAL, every 1ms*$_UT_EVTCNT_MOVE_HORIZONTAL,
//          and start a thread named "ObjB_Thread2" as EvtPuber postEVT(EvtID==TEST_KEEPALIVE) every 1ms*$_UT_EVTCNT_KEEPALIVE
